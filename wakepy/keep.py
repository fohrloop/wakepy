...
def _temporary_solution_for_using_old_functions_with_new_api(keep_screen_awake=False) -> ModeInfoTemporaryImplementation:
...
def running():
    ...
    yield from _temporary_solution_for_using_old_functions_with_new_api(keep_screen_awake=False) 
...
def presenting():
    ...
    yield from _temporary_solution_for_using_old_functions_with_new_api(keep_screen_awake=True) 
